        ...
        <script>
            (function(){
                ...
                var jQuerybutton = jQuery("<div id='source-button' class='btn btn-primary btn-xs'>&lt; &gt;</div>").click(function(){
                    var index =  jQuery('.bs-component').index( jQuery(this).parent() );
                    jQuery.get(window.location.href, function(data){
                        var html = jQuery(data).find('.bs-component').eq(index).html();
                ...
                jQuery(".icons-material .icon").each(function() {
                    jQuery(this).after("<br><br><code>" + jQuery(this).attr("class").replace("icon ", "") + "</code>");
                });
